...
/**
 * Mock data cho TokenMap - dựa trên Light.tokens.json
 */
export const mixedMappings: ColorMapping[] = [
  // Brand & Primary
  ...
  // Unknown / Unmapped colors (để test UI)
  ...
  { hex: "#FF0000", tokenName: null, count: 1, nodeId: "10:26" },
];

export const allMappedMappings = mixedMappings.filter((m) => m.tokenName !== null);
